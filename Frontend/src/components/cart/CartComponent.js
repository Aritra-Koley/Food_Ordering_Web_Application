  ...
  const itemObjToStore = { item, itemQuantity}
    ...
    const alertAreYouSureDelete = (id) =>{
      ...
      const alertAreYouSureFinalOrder = () =>{
        ...
        let textStr;
        if(localStorage.token === null || localStorage.token === undefined){
          textStr = "Final price is: "+ finalPriceVar.toFixed(2) + " Rupees! If you click yes, you will make final order!";
          itemsFromCartData = { itemsFromCart, address, phoneNumber, finalPrice: finalPriceVar};
          
        }
        else{
          textStr = "Final price is: "+ finalPriceVar.toFixed(2) + " Rupees (10% OFF)! If you click yes, you will make final order!";
            ...
            <div className='cart-item-container'>
              ...
              <div className='item-info-container'>
                ...
                <div className='item-price'>
                  {itemFromCart.mealPrice}.00 Rupees
                </div>
